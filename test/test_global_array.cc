...
double try_relative_difference()
{
    ...
    Tensor D1 = Tensor::build(kGlobalArray, "D1", Adims);
...
double try_2_norm()
{
    Dimension Adims = {4,5,6};
    Tensor A2 = Tensor::build(kCore, "A2", Adims);
    Tensor D2 = Tensor::build(kGlobalArray, "D2", Adims);
...
double try_zero()
{
    Dimension Adims = {4,5,6};
    Tensor A1 = Tensor::build(kCore, "A1", Adims);
    Tensor D1 = Tensor::build(kGlobalArray, "D2", Adims);
    Tensor A2 = Tensor::build(kCore, "A2", Adims);
    initialize_random(A1, A2);
...
double try_slice_rank0()
{
    ...
    Tensor A1 = Tensor::build(kCore, "A1", Adims);
    Tensor A2 = Tensor::build(kCore, "A2", Adims);
    Tensor A3 = Tensor::build(kGlobalArray, "A3", Adims);
    initialize_random(A1);
...
double try_slice_hard3_rank3()
{
    ...
    Tensor A2 = Tensor::build(kCore, "A2", Adims);
    Tensor A3 = Tensor::build(kGlobalArray, "A3", Adims);
    Tensor A4 = Tensor::build(kGlobalArray, "A4", Adims);
    initialize_random(A1);
